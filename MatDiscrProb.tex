   ...
   \section{Calcolo Combinatorio}
    ...
    \subsection{Teoria della Cardinalit\'a}
        ...
        \subsubsection{Esercizi}
            ...
            I sottoinsiemi di cardinalit\'a k(permutazioni) sono $\frac{(n)_k}{k!}$=$\frac{n\cdot(n-1)\cdot...\cdot(n-k+1)}{k\cdot(k-1)\cdot...\cdot1}$.\\
            Da finire : non so come si fa la parentesi con n sopra k.
